...
public class MusicLibrary extends JFrame { //JFrame is needed for GUI 
	...
	public MusicLibrary() {
		...
		btnBorrow.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				updateAlbumAvailability(); //Borrow Return button clicked -> update availability
			}
		});
	...
	private void searchAlbums() {
		...
		Album currentAlbum;
		/* TODO-02d: Call the AlbumQueries method that returns a list containing all albums from the database. After this step
		 * the application should show you the albums from the database. 
		 * TODO-03c: Pass the search string from the text field (txtSearchField) into the method call.
		 * TODO-03d: Test search with different search strings; artist name, album name, only part of the name etc.
		 */
	...
	private void updateAlbumAvailability() {
		 ...
		 *  
		 */
		searchAlbums(); //Let's query the db again to get the updated data.
	}
}
